class PromoPart < Part

  attr_accessible :promo_slides_attributes

  has_many :promo_slides

  accepts_nested_attributes_for :promo_slides, :allow_destroy => true
  ...
  def content
    ...
    promo_slides.each do |slide|
      slide_hash = slide.attributes.reject{ |k, v| reject_slide_attributes.include?(k) }
